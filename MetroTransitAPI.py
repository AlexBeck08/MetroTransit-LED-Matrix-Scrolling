...
def getTimes(updatedList):
    ...
    SB_Times = ','.join([str(elem) for elem in SB if type(elem) == int and elem < 100])
    EB_Times = ','.join([str(elem) for elem in EB if type(elem) == int and elem < 100])
    WB_Times = ','.join([str(elem) for elem in WB if type(elem) == int and elem < 100])
